...
var showAlert = function showAlert(type, message) {
  hideAlert();
  var divEl = "<div class='alert alert--".concat(type, "'>").concat(message, "</div>");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'Invalid password or email');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmFsYXlldmtlcmltIiwiYSI6ImNra3B6czBlcjAybmcydnAxYjF5djhqZnUifQ.tCpBv5cJ5xYGhUX-nqfmxA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            result = _context.sent;
            console.log(result);
            (0, _alerts.showAlert)('success', "".concat(type, " updated!"));
            setTimeout(function () {//location.reload({ forceReload: true });
            }, 500);
            _context.next = 15;
            break;
...
var stripe = Stripe('pk_test_51IiPUdJcc1mpeWP4pSvEdbYJbJHkZnpDpSctYamyRXOuvRVGQyGRpt7pYjy1tVS2vIWNBSaMwC7WdAMARArm1n6f00q6joYkQ7');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              formData.append('email', email), formData.append('photo', document.getElementById('photo').files[0]);
              /*  const data = {
                name: name,
                email: email,
              }; */
              ...
              (0, _updateSetting.updateSetting)(formData, 'User data');
...
if (updatePwdForm) {
  updatePwdForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var oldPwd, newPwd, confirmPwd, data;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              oldPwd = document.getElementById('password-current').value;
              newPwd = document.getElementById('password').value;
              confirmPwd = document.getElementById('password-confirm').value;
              data = {
                currentPassword: oldPwd,
                password: newPwd,
                confirmPassword: confirmPwd
              };
              (0, _updateSetting.updateSetting)(data, 'password');
...
if (logoutBtn) {
  logoutBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var result;
